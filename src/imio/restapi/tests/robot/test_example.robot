...
#
#  $ bin/test -s imio.restapi -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src imio.restapi.testing.IMIO_RESTAPI_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/imio/restapi/tests/robot/test_example.robot
#
